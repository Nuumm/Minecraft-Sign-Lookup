# Cubeville Sign Search Tool

This little tool searches every sign in a Cubeville world download and shows you what
they say and where they are. No Minecraft required, it just reads the world's save
files directly.

Works on all the old CV world downloads: CV3, CV4, CV5, CV6, Blipville, and CV7.
...
**Heads up on speed:** the bigger the world (CV3 → CV7), the longer the scan
takes since there's just more map to read. CV3 finishes in seconds, CV7
takes a bit longer, that's normal, just let it finish.
...
This works on both the old 1.16.5 worlds (CV3-CV6, Blipville) and CV7's 1.20.4
format, no need to do anything differently between them.
